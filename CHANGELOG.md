...
gstack now works with Factory Droid. Type `/office-hours` in Droid and get the same 29 skills you use in Claude Code. This makes gstack the first skill library that works across Claude Code, Codex, and Factory Droid.
