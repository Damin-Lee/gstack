...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, kiro, slate, cursor, openclaw, hermes, gbrain];
...
export { claude, codex, factory, kiro, slate, cursor, openclaw, hermes, gbrain };
